...
<div class= 'row'>
        ...
        <div class= 'row'>       
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><h3><?= h($tag->id) ?></h3></h3>
                </div>
                <div class="card-body">    
    ...
    <div class="col-md-3 col-lg-3">
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    <li class="list-group-item"><?= $this->Html->link(__('Edit Tag'), ['action' => 'edit', $tag->id],['class'=>'btn btn-outline-warning btn-pill']) ?> </li>
                    <li class="list-group-item"><?= $this->Form->postLink(__('Delete Tag'), ['class'=>'btn btn-outline-danger btn-pill','action' => 'delete', $tag->id], ['class'=>'btn btn-outline-danger btn-pill','confirm' => __('Are you sure you want to delete # {0}?', $tag->id)]) ?> </li>
